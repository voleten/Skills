...
#
# DIFFÉRENCE AVEC LA VERSION D'ORIGINE : celle-ci n'abandonne plus silencieusement
# quand `jq` est absent. Elle bascule sur python3, et si aucun analyseur JSON n'est
# disponible elle le signale explicitement (variable DENY_GUARD_WARN_FILE) au lieu
# de laisser croire que la protection est active.
